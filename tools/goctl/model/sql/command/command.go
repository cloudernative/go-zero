...
import (
	...
	"github.com/cloudernative/go-zero/core/stores/postgres"
	"github.com/cloudernative/go-zero/core/stores/sqlx"
	"github.com/cloudernative/go-zero/tools/goctl/config"
	"github.com/cloudernative/go-zero/tools/goctl/model/sql/command/migrationnotes"
	"github.com/cloudernative/go-zero/tools/goctl/model/sql/gen"
	"github.com/cloudernative/go-zero/tools/goctl/model/sql/model"
	"github.com/cloudernative/go-zero/tools/goctl/model/sql/util"
	file "github.com/cloudernative/go-zero/tools/goctl/util"
