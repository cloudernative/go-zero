...
import (
	"github.com/cloudernative/go-zero/tools/goctl/api/apigen"
	"github.com/cloudernative/go-zero/tools/goctl/api/dartgen"
	"github.com/cloudernative/go-zero/tools/goctl/api/docgen"
	"github.com/cloudernative/go-zero/tools/goctl/api/format"
	"github.com/cloudernative/go-zero/tools/goctl/api/gogen"
	"github.com/cloudernative/go-zero/tools/goctl/api/javagen"
	"github.com/cloudernative/go-zero/tools/goctl/api/ktgen"
	"github.com/cloudernative/go-zero/tools/goctl/api/new"
	"github.com/cloudernative/go-zero/tools/goctl/api/tsgen"
	"github.com/cloudernative/go-zero/tools/goctl/api/validate"
	"github.com/cloudernative/go-zero/tools/goctl/config"
	"github.com/cloudernative/go-zero/tools/goctl/internal/cobrax"
	"github.com/cloudernative/go-zero/tools/goctl/plugin"
