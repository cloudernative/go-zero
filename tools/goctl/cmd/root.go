...
import (
	...
	"github.com/cloudernative/go-zero/tools/goctl/api"
	"github.com/cloudernative/go-zero/tools/goctl/bug"
	"github.com/cloudernative/go-zero/tools/goctl/docker"
	"github.com/cloudernative/go-zero/tools/goctl/env"
	"github.com/cloudernative/go-zero/tools/goctl/gateway"
	"github.com/cloudernative/go-zero/tools/goctl/internal/cobrax"
	"github.com/cloudernative/go-zero/tools/goctl/internal/version"
	"github.com/cloudernative/go-zero/tools/goctl/kube"
	"github.com/cloudernative/go-zero/tools/goctl/migrate"
	"github.com/cloudernative/go-zero/tools/goctl/model"
	"github.com/cloudernative/go-zero/tools/goctl/quickstart"
	"github.com/cloudernative/go-zero/tools/goctl/rpc"
	"github.com/cloudernative/go-zero/tools/goctl/tpl"
	"github.com/cloudernative/go-zero/tools/goctl/upgrade"
