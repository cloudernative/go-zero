...
import (
	...
	"github.com/cloudernative/go-zero/tools/goctl/util/ctx"
)
...
const (
	...
	replacementBuilderx = "github.com/cloudernative/go-zero/core/stores/builder"
	goZeroMod           = "github.com/cloudernative/go-zero"
)
